...
>**Hybrid model**. A test of the hypothesized structural model had acceptable fit to the data: $\chi ^{2}(41) = 48.296, p = 0.202, CFI = 0.969, RMSEA = 0.063 (90%CI [0.000, 0.122])$. 
...
|tBIPOC |-->|Evals|-->|Climate|(0.569) X (-0.264)    |=  |-0.150      |0.129         |0.246      |
|cmBlack|-->|Evals|-->|Climate|(0.013) X (-0.264)    |=  |-0.003      |0.005         |0.460      |

|
|:------------------------------------------------------:|:----------:|:------------:|:---------:|
|                                                        |$B$         | $SE$         |$p$        |
|Total indirect effect                                   |-0.544      |0.132         |0.243      |
|Direct effect of tBIPOC on Climate (c'1 path)           |-0.365      |0.340         |0.283      |
|Direct effect of cmBlack on Climate (c'2 path)          |-0.025      |0.017         |0.145      |
...
|:------------------------------|:-----------------------------------:|:------------:|
|Factor loadings significant, strong, proper valence| |Yes            | 
|Non-significant chi-square     |$\chi ^{2}(41) = 48.296, p = 0.202$|Yes|  
|$CFI\geq .95$                  |CFI = 0.969                     |Yes           |  
|$RMSEA\leq .05$ (but definitely < .10)|RMSEA = 0.063, 90%CI(0.000, 0.125)|Yes|  
|$SRMR\leq .08$ (but definitely < .10) |SRMR = 0.067          |Yes          | 
|Combination rule: $CFI \geq .95$ and $SRMR \leq .08$|CFI = 0.969, SRMR =  0.067 |Yes   |
...
>**Hybrid model**. A test of the hypothesized structural model had acceptable fit to the data: $\chi ^{2}(41) = 48.296, p = 0.202, CFI = 0.969, RMSEA = 0.063 (90%CI [0.000, 0.122])$. While the fit of the structural model was strong and positive, there were no significant direct or indirect effects. Results are found in Table 2. 
...
|7. Respecify measurement model with parcels.|    5        |_____  |  
|8. Specify and evaluate a structural model; tweak as necessary.|    5        |_____  |   
|9. APA style results with table(s) and figure.|    5        |_____  |       
