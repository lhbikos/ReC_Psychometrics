...
# EFA: Principal Components Analysis {#PCA}
...
# EFA: Principal Axis Factoring {#PAF}
...
## Exploratory Factor Analysis (with a quick contrast to Principal Components Analysis)
