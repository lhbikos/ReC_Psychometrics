...
* The **upper right window** includes several tabs:
  + Environment: it lists the *objects* that are available to you (e.g., dataframes)
* The **lower right window** has a number of helpful tab:
...
* The **primary window** is where we work:
...
R has cheat sheets for everything, here's one for R Markdown:  https://www.rstudio.com/wp-content/uploads/2015/02/rmarkdown-cheatsheet.pdf 
