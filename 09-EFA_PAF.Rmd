...
![Image of the workflow for PAF](images/PAF/PAFworkflow.png) (COMMENT: I think we may need to update the image here as in the yellow chunk, it says to run a PCA with an equal number of items rather than run a PAF with fewer items) 
