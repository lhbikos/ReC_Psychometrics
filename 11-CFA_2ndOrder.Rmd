...
### Partial Write-up
*Redunancy in APA partial write-up: there are two write-ups for the uncorrelated model, and no write-up for the correlated model*
...
```
**#This code was confusing, and could use more explanation. I had a hard time working this matrix, and it might be helpful for it to be clarified. I also, just could be confused. **
